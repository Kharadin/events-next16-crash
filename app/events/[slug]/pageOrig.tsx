// this is alternative version of the file.using cached components instaead of suspense
...
const EventDetailsPage = async ({params}: {params: Promise<{slug: string}>}) => {
    'use cache' // this is alternative to using Suspense in the other ver of file.
    cacheLife('hours');
